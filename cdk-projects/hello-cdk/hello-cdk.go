/*
This file is a sample tutorial-based project.

Refer to https://docs.aws.amazon.com/cdk/v2/guide/hello-world.html
*/
...
func NewHelloCdkStack(scope constructs.Construct, id string, props *HelloCdkStackProps) awscdk.Stack {
	...
	myFunction := awslambda.NewFunction(stack, jsii.String("HelloWorldFunction"), &awslambda.FunctionProps{
		...
		exports.handler = async function(event) {
			return {
			statusCode: 200,
			body: JSON.stringify('Hello World! I am created by CDK.'),
			};
		};
		`)),
	})
...
func env() *awscdk.Environment {
	...
	return &awscdk.Environment{
	 Account: jsii.String("096966628981"),
